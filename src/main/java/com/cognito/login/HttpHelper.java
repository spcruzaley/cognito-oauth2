...
public class HttpHelper {
    ...
    @Value("${spring.security.oauth2.client.registration.cognito-client-for-token.client-id}")
    private String clientIdForToken;
    @Value("${spring.security.oauth2.client.registration.cognito-client-for-token.client-secret}")
    private String clientSecretForToken;
    @Value("${spring.security.oauth2.client.registration.cognito-client-for-token.redirect-uri-template}")
